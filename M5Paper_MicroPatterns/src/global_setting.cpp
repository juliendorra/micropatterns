...
// - MPNetworkManager (WiFi, HTTP, NTP constants)
...
// WiFi credentials, API URLs, NTP server, and CA cert are now typically consts within `MPNetworkManager.cpp`
// or loaded from configuration by `MPNetworkManager`/`SystemManager`.
